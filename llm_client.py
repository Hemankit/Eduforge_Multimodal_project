...
class LLMClient:
    ...
    Features:
    - Dynamic provider selection (local, OpenAI, Anthropic, Together)
    ...
    def repair_loop(self, prompt: str, max_retries: int = 3):
        """
        ...
        for attempt in range(max_retries):
            try:
                ...
                return ContentInput.model_validate(data)
...
"""
        ...
        raise RuntimeError("Failed to produce valid structured output after repair attempts")
